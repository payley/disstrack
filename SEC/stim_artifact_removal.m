...
function stim_artifact_removal(DataStructure,idxA,idxD,algorithm,tBefore,tAfter,meth,polyOrder)
        ...
        for j = 1:length(StimOn)
            if StimOn(j)== 1
                ...
                for iC = 1:length(CHANS)
                    ...
                    switch algorithm
                        case 'Bundy'
                            [data,tAfter_ms,PeakedDelay,FalloffDelay] = stim_artifact_removal_algorithm(SmoothData,algorithm, ...
                                fs,StimOnsets,StimOffsets,tBefore,tAfter,meth,polyOrder);
                        ...
                        case 'Fra'
                            [data] = stim_artifact_removal_algorithm(SmoothData,algorithm, ...
                                fs,StimOnsets,StimOffsets);
                            tAfter_ms = 0;
                            PeakedDelay = 0;
                            FalloffDelay = 0;
                            OutFile = fullfile('C:\MyRepos\disstrack\SEC',algorithm,curFileName,...
