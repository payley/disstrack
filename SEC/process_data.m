...
meth = 'SlidingPoly';
polyOrder = 8; 
stim_artifact_removal(DataStructure,idxA,idxD,algorithm,tBefore,tAfter,meth,polyOrder);
...
useCAR = 0;
smoothBW_ms = 0.2;
NResamp = 1000; % number of repetitions of shuffled data, precedent is 10,000
